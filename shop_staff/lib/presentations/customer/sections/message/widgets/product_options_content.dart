...
class ProductOptionsContent extends StatelessWidget {
  const ProductOptionsContent({required this.payload, super.key});
                    ...
                    child: options.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final groupName =
                                  (opt['groupName'] ?? '') as String? ?? '';
                              final optName =
                                  (opt['optionName'] ?? '') as String? ?? '';
                              final qty =
                                  (opt['quantity'] as num?)?.toInt() ?? 1;
                              final extra =
